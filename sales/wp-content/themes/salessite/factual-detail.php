            ...
            <div  class="banner-wrapper">
                <div class="container-lg">
					...
					<div class="hidden-md hidden-lg hidden-sm visible-xs mobileoverlay-wrap">
                        ...
                        <div class="detail-banner-box"><!-- style="background: url({{(CastingVariable.hero_image !=null &&  CastingVariable.hero_image!= undefined) && CastingVariable.hero_image != '' ? CastingVariable.hero_image : (SeriesDetailsInformation.SeriesImageUrl!=null && SeriesDetailsInformation.SeriesImageUrl!='' && SeriesDetailsInformation.SeriesImageUrl!=undefined ? SeriesDetailsInformation.SeriesImageUrl :ViewBannerDefault) }}) scroll 0 0;">-->
...
{{SeriesDetailsInformation.EpisodesCount===0? '' : SeriesDetailsInformation.EpisodesCount}}{{(SeriesDetailsInformation.EpisodesCount === 0 || SeriesDetailsInformation.EpisodesCount===undefined )? '' : (SeriesDetailsInformation.EpisodesCount === 1 ? 'Episode' : ' Episodes' )}}</span>
                            ...
                            <div class="banner-btngroup details-btngroup container">
                              <a href="#" class="button-md btn-gold hidden-sm print-mainbtn" ng-click="printPDF()">
                                ...
                                <a href="#" class="button-md btn-gold {{SeriesDetailsInformation.SeriesID +'plus'}}" ng-click="AddToWatchlist(SeriesDetailsInformation.SeriesID,bannerProgramType);"><span class="addlist-btn">Add to watchlists</span></a>
								 <a href="#" class="button-md btn-gold {{SeriesDetailsInformation.SeriesID +'minus'}}" ng-click="AddToWatchlist(SeriesDetailsInformation.SeriesID,bannerProgramType);" style="display:none"><span class="removelist-btn">Remove from watchlists</span></a>
            ...
            <div ng-show='totalPage' class="dark-bg-large detail-darkbg last-box border-top-none" >

                <section>
                    <div class="hidden-lg hidden-md hidden-sm visible-xs banner-info"  ng-cloak>
...
{{SeriesDetailsInformation.EpisodesCount===0? '' : SeriesDetailsInformation.EpisodesCount}}{{(SeriesDetailsInformation.EpisodesCount === 0 || SeriesDetailsInformation.EpisodesCount===undefined )? '' : (SeriesDetailsInformation.EpisodesCount === 1 ? 'Episode' : ' Episodes' )}}</span>
						  ...
						  <p class="average-count" ng-show='(EpisodeArray.length >0 && EpisodeArray.length >= 2) && (SeriesDetailsInformation.AveragePieceLength!= null  && SeriesDetailsInformation.AveragePieceLength!= undefined  && SeriesDetailsInformation.AveragePieceLength!= "0")' class="average-count hidden-xs">Average duration per episode:{{SeriesDetailsInformation.AveragePieceLength >=2 ? ' '+SeriesDetailsInformation.AveragePieceLength+' hours':' '+SeriesDetailsInformation.AveragePieceLength+' hour'}}</p>
								<p class="average-count" ng-show='(EpisodeArray.length >0 && EpisodeArray.length < 2)&& (SeriesDetailsInformation.AveragePieceLength!= null && SeriesDetailsInformation.AveragePieceLength!= "NULL" && SeriesDetailsInformation.AveragePieceLength!= undefined  && SeriesDetailsInformation.AveragePieceLength!= 0)' class="average-count hidden-xs">Duration: {{SeriesDetailsInformation.Duration >=2 ? SeriesDetailsInformation.AveragePieceLength+' hours' : SeriesDetailsInformation.AveragePieceLength+' hour'}}</p>
                    ...
                    <div ng-show='false' class="hidden-lg hidden-md hidden-sm visible-xs detailbtn-xs">
                            ...
                            <section class="episode-box episode-detail-sm" >
                                    ...
                                    <div class="container swiper-slide-heading"  ng-show="SeasonAvailable">
                                        ...
                                        <div class="demo-section k-content" >
                                            ...
                                            <div class="col-md-6 col-xs-12 col-sm-6 detail-desc-box-right">
                                                ...
                                                <button  class="button-md btn-gold margin-top30 hidden-xs addseasonbtn-xs btn-auto" ng-click="AddSeasonToWatchlist(SeasonListIndividual.SeasonID,'season');">
                                                  <span id="{{SeasonListIndividual.SeasonID}}-{{SeasonListIndividual.SeasonNumber}}-{{SeasonListIndividual.SeasonPart}}-season">Add Season {{SeasonListIndividual.SeasonNumber}}{{SeasonListIndividual.SeasonPart!=null?'-SeasonListIndividual.SeasonPart':''}} to watchlists</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="container swiper-slide-heading"  ng-cloak>
                                                        <div id="'firstrow'+$index" class="row">
                                                            <div class="col-md-4 col-xs-12">
                                                              ...
                                                              <button  class="button-md btn-gold hidden-sm hidden-xs btn-auto" ng-click="AddEpisodeToWatchlist(EpisodeViewInformation.PieceID,'piece');">
                                                                <span id="{{EpisodeViewInformation.PieceID}}episode">Add Episode to Watchlists</span>
                                                              </button>
                                                            </div>
                                ...
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/play_btn.png" alt="back_btn">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12 trailer-pop-btn hidden-md hidden-lg hidden-xs">
                                                                <button class="button-md btn-gold visible-sm add-episode-btn-sm"  ng-click="AddEpisodeToWatchlist(EpisodeViewInformation.PieceID,'piece')" >
                                                                  <span id="{{EpisodeViewInformation.PieceID}}episode">Add Episode to Watchlists</span>
                                                                </button>
                                                              </div>
                              ...
                              <img ng-show='!isPlayClicked' ng-src="{{episodeshow.ImageUrlDesktop2x ? episodeshow.ImageUrlDesktop2x : episodeshow.EpisodeImageUrl}}">
                                ...
                                <!--CAST members end-->
                                <div class="dark-bg-medium last-box-rating last-box" ng-show="LastDetails || ratingResponse.length>0">
                                                ...
                                                <div ng-show="ratingResponse.length>=2" class="col-md-3 col-sm-3 hidden-xs hidden-sm text-center rating-box">
                                                    ...
                                                    <div ng-show='ratingResponse.length===4 && ratingResponse[2].rating_type==="Star"' ng-click="ratingNumber(ratingResponse[2],'rating3')" class="circle-wrapper hidden-xs hidden-sm margin-btm0 rating3" >
                                                        <div class="review-circle ">
                                                            ...
                                                            <div class="stars-aj">
                                                               <span class="star-selected" ng-repeat="i in range(ratingResponse[2].rating/2)" ></span>
    ...
    <div class="swiper-container ratingSwiper swiper-container-padding swiper-rating-border">
        ...
        <div class="swiper-button-prev swiper-button-prev-rating"></div>
                                   ...
                                   <div class="overlayLoader-wrapper-search">
											<div id="overlayLoaderForYouMayInterestedIn" style="display:none"><img id="loading" src="<?php echo BASE_CDN_URL ?>/images/ajax-loader.gif"></div>
											 <div  class="dark-bg last-box" ng-show="YoumayInstredinArray.SeriesDetail.length>0">
											 
                                    <div class="container swiper-slide-heading">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="swiper-heading">you may also be interested in...</h3>
                            ...
                            <div class="swiper-wrapper" >
                                <div class="swiper-slide"  ng-repeat="series in YoumayInstredinArray.SeriesDetail | limitTo: 10" data-toggle="collapse">                                    
                                 ...
                                 <div class="plus-img" >
								  ...
								  <div  ng-show='YoumayInstredinArray.SeriesDetail.length>10'  class="swiper-slide browseMore-box">
                                                            <div class="browseMore playbtn-thumb">
                                                            <a  ng-click="youmayInterestedListing()">Browse more titles  <span class="findout-bacgrndimage"></span></a>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12 select-allcheckbox dropdown-group" ng-hide="programTypeThis==='Episodes'">
                                           <div id="example"  class="ae-dropdown-small ae-dropdown-xs">
                                            ...
                                            <select kendo-drop-down-list style="width: 100%;"  ng-model="SeasonAssetLists" k-option-label="'Filter By Season'" k-data-text-field="'Season'" k-data-value-field="'id'" k-on-change='Seasonchange(SeasonAssetLists)'  k-data-source="SeasonsListForDropdown" ng-disabled='SeasonsListForDropdown.length<=0 || SeasonsListForDropdown===undefined || SeasonsListForDropdown==="" || SeasonsListForDropdown===null' >
                                             ...
                                             <!--  <option  value='{{seasondetails.SeasonID}}' ng-repeat='seasondetails in SeasonListDetails | orderBy:"-SeasonNumber"'>{{'Season '+seasondetails.SeasonNumber}}</option>-->
                                              </select>
											</div>
											</div>
...
<div class="print-main print-container">
  ...
  <div class="container-lg">
    ...
    <section class="text-center center-heading-box" ng-if="SeasonListDetails.length>0">
